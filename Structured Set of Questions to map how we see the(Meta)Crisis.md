---
created: 2026-01-05
description: A structured set of multiple-choice questions to map how people understand today’s crises and their underlying causes
---
A short, structured set of questions to get a clear sense of how someone sees our current civilizational situation: both the symptoms we're facing and how they diagnose their root causes.

The questions are deliberately constrained, not to oversimplify, but to make it easier to see where people align, where they differ, and where the real cruxes are.
 
Whilst the overall structure is generic is aligns with our [[metacrisis]] & [[Second Renaissance]] framework and specifically the the four noble beliefs:
...
I’m deliberately keep the questions close to yes/no or multiple choice. Not because the situation is simple, but to keep this focused and structured -- otherwise conversations can go off in lots of different directions very quickly. For example, if we ask something like "what are the limits of techno-solutionism?" or "where does technology genuinely enable collective intelligence?", that opens up a huge space.

What we want first is a sharper signal: what do you agree with, what do you disagree with, and where do we locate the crux?
...
Below is a consolidated, cleanly structured sequence, keeping the questions essentially unchanged and applying consistent Markdown formatting.

I’ve treated this as a single interview flow with four sections. Sections are level-2 headings; each numbered question is a level-4 heading. I’ve kept titles minimal and descriptive, without over-interpreting them.
...
Over a 5-year horizon, where does change matter most?
Over a 50-year horizon, where does change matter most?
(Forced choice each time from the same list as above.)
