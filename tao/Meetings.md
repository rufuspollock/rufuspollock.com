...
- Allow time after the meeting (for that person) to process notes. A rough rule of thumb is 25% of time of the meeting for processing e.g. for a 2h meeting allow 30m.
  ...
  - NB: Not all meetings require this :smile:
...
Deleting meeting note content ... Instead use "MOVED" or an explicit transfer note with info on where it was processed to. Why? So we can find the original log (sometimes stuff will get mis-processed).
